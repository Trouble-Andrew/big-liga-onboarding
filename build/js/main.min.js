...
/* harmony import */ var _animateMascot__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animateMascot */ "./js/modules/animateMascot.js");
...
var nextScreen = function nextScreen() {
  ...
  setTimeout(function () {
    ...
    Object(_animateMascot__WEBPACK_IMPORTED_MODULE_0__["animateMascot"])();
  }, 500);
  window.removeEventListener('keydown', nextScreenEnter);
};

var nextScreenEnter = function nextScreenEnter() {
  if (event.keyCode === 13) {
    nextScreen();
  }
};
