...
/* harmony import */ var _modules_init_first_screen__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-first-screen */ "./js/modules/init-first-screen.js");
/* harmony import */ var _modules_toggle_screen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/toggle-screen */ "./js/modules/toggle-screen.js");
...
Object(_modules_init_first_screen__WEBPACK_IMPORTED_MODULE_3__["initFirstScreen"])();
Object(_modules_toggle_screen__WEBPACK_IMPORTED_MODULE_4__["toggleScreen"])();
var button = document.querySelector('.first-screen__button');
...
/***/ "./js/modules/animate-mascot.js":
/*!**************************************!*\
  !*** ./js/modules/animate-mascot.js ***!
  \**************************************/
/*! exports provided: animateMascot */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animateMascot", function() { return animateMascot; });
var lightning1 = document.querySelector('#lightning-1');
var lightning2 = document.querySelector('#lightning-2');
var lightning3 = document.querySelector('#lightning-3');
var lightning4 = document.querySelector('#lightning-4');
var roar1 = document.querySelector('#roar-1');
var roar2 = document.querySelector('#roar-2');

var animateMascot = function animateMascot() {
  [lightning1, lightning2, lightning3, lightning4, roar1, roar2].forEach(function (lightning) {
...
/***/ "./js/modules/init-first-screen.js":
/*!*****************************************!*\
  !*** ./js/modules/init-first-screen.js ***!
  \*****************************************/
/*! exports provided: initFirstScreen */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFirstScreen", function() { return initFirstScreen; });
/* harmony import */ var _animate_mascot__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-mascot */ "./js/modules/animate-mascot.js");

var firstScreen = document.querySelector('.first-screen');
var mainScreen = document.querySelector('.main-screen');
var mainButton = document.querySelector('.first-screen__button');
var logoMain = document.querySelector('.logo__main');
var logoLeft = document.querySelector('.logo__left');
var logoRight = document.querySelector('.logo__right');
...
var nextScreen = function nextScreen() {
  ...
  setTimeout(function () {
    ...
    Object(_animate_mascot__WEBPACK_IMPORTED_MODULE_0__["animateMascot"])();
  }, 500);
  window.removeEventListener('keydown', nextScreenEnter);
};

var nextScreenEnter = function nextScreenEnter(event) {
  if (event.keyCode === 13) {
    nextScreen();
  }
};

var initFirstScreen = function initFirstScreen() {
...
/***/ "./js/modules/toggle-screen.js":
/*!*************************************!*\
  !*** ./js/modules/toggle-screen.js ***!
  \*************************************/
/*! exports provided: toggleScreen */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleScreen", function() { return toggleScreen; });
var leftScreen = document.querySelector('.left-screen');
var rightScreen = document.querySelector('.right-screen');

var toggleScreen = function toggleScreen() {
  leftScreen.addEventListener('click', function () {
    rightScreen.classList.add('right-screen--visible');
  });
  rightScreen.addEventListener('click', function () {
